...
function AddToPropertyImage(prop) {
  ...
  const uploadPicture = async e => {
    ...
    await axios
      .post(
        "http://localhost:8081/property-upload/picture/" + getPropertyId(),
        formData,
        {
          headers: {
  ...
  useEffect(() => {
    ...
    //   history.push("/agent/edit-property-pictures");
    // }
  }, []);
...
export default AddToPropertyImage;
